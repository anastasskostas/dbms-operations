 ...
 * Author: Tasos
 *
 * Created on April 17, 2015, 1:13 PM
 */
/*
 *  ==========================================================================================
...
#define MAX_RECORDS_PER_BLOCK 100   // number of records for each block   
#define MAX_RECORD_NUM 1000         // max random integer for the field "number" in record
#define NUM_OF_BLOCKS 20            // number of blocks in the file

#define SEG1 "_segments_1.bin"
#define SEG2 "_segments_2.bin"
